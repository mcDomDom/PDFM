...
;		     Nov 2007     Ported to NEC PC-9801/9821
...
;*****************************************************************************
NE_DATAPORT	EQU	200h		; NE2000 Port Window.
NE_RESET	EQU	18h		; Issue a read for reset
EN_OFF		equ	0h
...
io_addr		dw	00d0h,0		; I/O address for card (jumpers)

	public	driver_class, driver_type, driver_name, driver_function, parameter_list
driver_class	db	BLUEBOOK, IEEE8023, 0		;from the packet spec
driver_type	dw	54		;from the packet spec
driver_name	db	'LGY-98',0	;name of the driver.
